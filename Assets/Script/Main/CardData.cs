...
public class CardData2
{
   public struct cardData
    ...
    {  new cardData("이름자리입니다","내용입니다",0,0,0,0,0),
       new cardData("기본공격","-적 한명에게 데미지: <color=red><b>5</color></b>",1,0,0,1,1),
       new cardData("통상방어","-자신에게 방어도:7",1,0,0,2,0),
       new cardData("백스텝","-적 한명에게 데미지:7\n-드로우:1",2,0,0,3,1),
       new cardData("준비태세","-드로우:2",2,0,0,4,0),
       new cardData("심연속 요동","-망자부활:6\n-덱에 이 카드 한장을 복사해 넣는다.",1,1,0,5,0),
       new cardData("푸른 화염체","-망자부활:3\n-적 한명에게 2번의 데미지:7\n-다음 턴 시작시 코스트+1",3,1,0,6,1),
       new cardData("누더기 제조","-망자부활:4\n-묘지에서 패로 카드 2장을 선택해 가지고 온다.",2,1,0,7,2),
       new cardData("방어전술","-자신에게 방어도:5\n-이번 턴 종료시 남은 코스트 1당 자신에게 방어도:10",1,3,0,8,0),
       new cardData("인고의 노력","-다음 턴 시작시 자신에게 방어도:16",1,3,0,9,0),
