...
public class CharacterInfo
{
    public struct characterData
    {
        ...
        public characterData(string name, int no, int cost, int atk, int def, float speed, int maxHp, string[] passive, string[] passiveContent, string specialEquipName, string specialEquipContent)
        {
            Name = name;
            No = no;
            Cost = cost;
    ...
    {
        new characterData("이름",0,0,0,0,0,0,new string[]{"패시브1","패시브2","패시브3","패시브4"},new string[]{"패시브1설명","패시브2설명","패시브3설명","패시브4설명" },"전용 장비 이름","전용 장비 설명"),
        ...
        ,"깨진 유리 심장","전체:\n턴 시작 시 망자가 200명일 때,해당 전투에서 승리한다.\n턴 종료시 아군 전체의 HP가 5 회복한다."),
          ...
          ,"피묻은 곡옥","전방:\n턴 시작 시 반가라를 제외한 아군 전체에게 방어도: 반가라의 방어도"),
